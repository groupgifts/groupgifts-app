...
{/* Close pool button */}
        {pool.status === 'active' && user && pool.organiser_id === user.id && (
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100">
              ...
              {!confirmClose ? (
                ...
                <div className="flex flex-col gap-2">
                  <p className="text-sm text-gray-700 font-medium text-center">Are you sure? This cannot be undone.</p>
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-[#0D0D0D] text-white py-2.5 rounded-xl text-sm font-semibold disabled:opacity-50">
        ...
        {pool.status === 'paid_out' && user && pool.organiser_id === user.id && (
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="bg-green-50 rounded-2xl p-5 border border-green-100 text-center">
              <div className="text-2xl mb-2">🎉</div>
              <div className="text-sm font-semibold text-green-800">Pool closed — payout requested</div>
              <div className="text-xs text-green-600 mt-1">Funds will arrive in your account within 2 business days.</div>
            </div>
          </div>
        )}
        ...
        {user && pool.organiser_id === user.id && (
          <div className="mt-4 text-center">
            {!confirmDelete ? (
              ...
              <div className="bg-white rounded-2xl p-4 border border-red-100 flex flex-col gap-2">
                <p className="text-sm text-gray-700 font-medium">Delete permanently? All contributions will be refunded first.</p>
                <div className="flex gap-2">
